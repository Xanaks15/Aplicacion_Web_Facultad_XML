      ...
      <div id="accordion">
              ...
              <div class="container">
                <div class="form-row">
                  <div class="form-group col-md-4">
                    ...
                    <input type="number" name="id_profesor" class="form-control" required <?php if (isset($_GET["id"])) {
                      echo "value='" . $_GET["id"] . "' disabled";
                    } ?>>
                  ...
                  <div class="form-group col-md-8">
                    ...
                    <input type="text" name="nombre" class="form-control" required <?php if (isset($_GET["id"])) {
                      echo "value='" . $profesor[0]->nombre . "'";
                    } ?>>
                  </div>
                </div>
                <div class="form-row">
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" name="cubiculo" class="form-control" required <?php if (isset($_GET["id"])) {
                      echo "value='" . $profesor[0]->ubicacion . "'";
                    } ?>>
                  </div>
                  <div class="form-group col-md-8">
                    <label>Correo:</label>
                    <input type="text" name="correo" class="form-control" required <?php if (isset($_GET["id"])) {
                      echo "value='" . $profesor[0]->correo_electronico . "'";
                    } ?>>
                  </div>
                </div>
              </div>
              ...
              <div class="container">
                <div class="form-row">
                  <div class="form-group col-md-12">
                    <label>Autores:</label>
                    <input type="text" name="autores" class="form-control" <?php if (isset($_GET["id"])) {
                      echo "value='" . $profesor[0]->publicaciones->publicacion->autores . "'";
                    } ?>>
                  </div>
                </div>
                <div class="form-row">
                  <div class="form-group col-md-9">
                    ...
                    <input type="text" name="titulo_pub" class="form-control" <?php if (isset($_GET["id"])) {
                      echo "value='" . $profesor[0]->publicaciones->publicacion->titulo . "'";
                    } ?>>
                  </div>
                  <div class="form-group col-md-3">
                    <label>Año de publicación:</label>
                    <input type="number" name="anio" class="form-control" <?php if (isset($_GET["id"])) {
                      echo "value='" . $profesor[0]->publicaciones->publicacion->anio . "'";
                    } ?>>
                  </div>
                </div>
              </div>
        ...
        <div class="card">
          ...
          <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
            <button type="button" class="btn btn-success" style="margin-left: 30px; margin-top: 10px;"
              id="clonar_materia">Agregar Materia</button>
            <button type="button" class="btn btn-danger" style="margin-top: 10px;" id="eliminar_materia">Eliminar
              Materia</button>
